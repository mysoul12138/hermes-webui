...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    providers_key_placeholder_replace: 'Saved; enter a new key to replace',
    ...
    providers_models_refreshed: 'Models refreshed for {0}',
  ...
  folder_add_as_space_title: 'スペースとして追加?',
    ...
    discard: '破棄',
    project_name_prompt: 'プロジェクト名:',
    providers_models_refreshed: '{0} のモデルを更新しました',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    providers_key_placeholder_replace: '已保存，输入新密钥以替换',
    ...
    providers_models_refreshed: '{0} 的模型已刷新',
